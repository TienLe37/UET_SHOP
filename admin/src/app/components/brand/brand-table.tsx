      ...
      <>
                  ...
                  .map((item) => (
                    ...
                    >
                      ...
                      <td className="pr-8 py-5 whitespace-nowrap">
                        <a href={`/brands/${item._id}`} className="flex items-center space-x-5">
                          {item.logo && (
                            <Image
        ...
        {brandItems.length > countOfPage &&<div className="flex justify-between items-center flex-wrap">
          <p className="mb-0 text-tiny">
            Hiện thị {pageStart + 1}-
            {Math.min(brandItems.length, pageStart + countOfPage)} của 
            {brandItems.length} thương hiệu
          </p>
