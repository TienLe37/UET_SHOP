      ...
      <div className="col-span-12 lg:col-span-4">
        <form onSubmit={handleSubmit((data) => handleSubmitEditBrand(data, id))}>
          <div className="mb-6 bg-white px-8 py-8 rounded-md">
            ...
            {/* Form Field */}
            <BrandFormField default_val={brand.name} register={register} errors={errors} name="Name" title="Tên thương hiệu" isReq={true} />
            <BrandFormField default_val={brand.email} register={register} errors={errors} name="Email" title="Email" isReq={true} />
            <BrandFormField default_val={brand.website} register={register} errors={errors} name="Website" title="Website" isReq={false} />
            <BrandFormField default_val={brand.location} register={register} errors={errors} name="Location" title="Địa chỉ" isReq={false} />
            {/* Form Field */}
            ...
            <button className="tp-btn px-7 py-2">Chỉnh sửa</button>
          </div>
        </form>
      </div>
    )
