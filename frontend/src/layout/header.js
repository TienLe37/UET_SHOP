            ...
            <div className="container-fluid">
              ...
              <div className="mega-menu-wrapper">
                <div className="row align-items-center justify-content-between">
                  ...
                  <div className="col-xxl-1 col-xl-1 col-lg-4 col-md-4 col-sm-5 col-8">
                    <div className="logo">
                      <Link href="/">
                        <h3>ShopEcom</h3>
                      </Link>
                  ...
                  <div className="col-xxl-6 col-xl-7 d-none d-xl-block">
                    <div className="main-menu main-menu-13 main-menu-ff-space">
                          ...
                          <li className="d-xxl">
                            {
                              isSearchFormOpen
                                ? (
                                  ...
                                  <button onClick={toggleSearchForm} className={`${isSearchFormOpen ? "d-none" : "d-block"}`}>
                                    <Search />
                                  </button>
                                )
                            }
